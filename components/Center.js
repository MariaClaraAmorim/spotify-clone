...
function Center() {
  ...
  const authenticationStatus = session
    ? {
        text: (
          <div>
    ...
    : {
        text: (
          <a href="/login" className="flex items-center p-3 bg-[#2e2e2e] space-x-3 opacity-90 hover:opacity-80 cursor-pointer rounded-full pr-2">
